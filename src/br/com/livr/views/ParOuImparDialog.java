...
public class ParOuImparDialog extends javax.swing.JDialog {
    ...
    private void btnJogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJogarActionPerformed
        ...
        getRbParEImpar().forEach((rbtn) -> {
            if (rbtn.isSelected()) {
                if (rbtn.getText().equalsIgnoreCase("par")) {
                    setVenceuParOuImpar(getTecnico().tirarParOuImpar(sliderQuantidadeDedos.getValue(), true));
                } else {
                    setVenceuParOuImpar(getTecnico().tirarParOuImpar(sliderQuantidadeDedos.getValue(), false));
                }
            }
        });
        ...
        getNotificacao().exibirNotificacao("Quem começa!?", getQuemComeca(), "shamrock.png", true, 3);
